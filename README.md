...
This page will help you install and build your first React Native app. (11 kB)
https://reactnative.dev/docs/environment-setup

reactnative.devreactnative.dev
Introduction · React Native
This helpful guide lays out the prerequisites for learning React Native, using these docs, and setting up your environment. (11 kB)
...
Customizable Icons for React Native with support for image source and full styling. - GitHub - oblador/react-native-vector-icons: Customizable Icons for React Native with support for image source a... (135 kB)
